 ...
 */
final class Version20210426200056 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE information (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, society VARCHAR(255) NOT NULL, domain VARCHAR(255) NOT NULL, provider_society VARCHAR(255) NOT NULL, provider_domain VARCHAR(255) NOT NULL, valide_date DATETIME NOT NULL, expire_date DATETIME NOT NULL, INDEX IDX_29791883A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
